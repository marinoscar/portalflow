// Mirror of tools/cli/src/llm/provider-kinds.ts — kept in sync manually for v1.
// Do NOT change preset IDs, labels, default models, or base URLs without updating
// the CLI source as well, so that the two systems stay aligned.
